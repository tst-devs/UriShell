...
#warning Not sure if this class should be common. It's specific to the Phoenix app and uses RX as well.
	///// <summary>
	...
	///// </summary>
	//[Obsolete("Not sure if this class should be common. It's specific to the Phoenix app and uses RX as well.")]
